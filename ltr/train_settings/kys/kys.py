...
import os
from ltr.dataset import Lasot, Got10k, TrackingNet, FE108
...
def run(settings):
    ...
    settings.description = 'Default train settings for KYS with ResNet50 as backbone.'
    ...
    data_processing_train = processing.EKYSProcessing(search_area_factor=settings.search_area_factor,
    ...
    data_processing_val = processing.EKYSProcessing(search_area_factor=settings.search_area_factor,
                                                   output_sz=settings.output_sz,
                                                   center_jitter_param=settings.center_jitter_param,
                                                   scale_jitter_param=settings.scale_jitter_param,
                                                   proposal_params=proposal_params,
    ...
    dataset_train = sampler.KYSSampler([fe108_train],
                                       [1],
    ...
    dataset_val = sampler.KYSSampler([fe108_val], [1], samples_per_epoch=1000,
