...
class Backbone(BackboneBase):
    ...
    def __init__(self,
        ...
        backbone = backbones.resnet50_transt(output_layers=output_layers, pretrained=pretrained,
                                      frozen_layers=frozen_layers)
        num_channels = 1024
...
def build_backbone(settings, backbone_pretrained=True, frozen_backbone_layers=()):
    ...
    param = backbone.body.conv1.weight
    backbone.body.conv1 = nn.Conv2d(2, 64, kernel_size=7, stride=2, padding=3, bias=False)
    backbone.body.conv1.weight.data = param[:, :2, :, :]
