...
class BaseTrainer:
    ...
    def save_checkpoint(self):
        ...
        if hasattr(self, 'snn'):
            if self.snn is not None:
                snn_state_dict = self.snn.module.state_dict() if multigpu.is_multi_gpu(self.snn) else self.snn.state_dict()
            else:
                snn_state_dict = None
        else:
            snn_state_dict = None
    ...
    def load_checkpoint(self, checkpoint = None, fields = None, ignore_fields = None, load_constructor = False):
        ...
        for key in fields:
            ...
            elif key == 'snn' and hasattr(self, 'snn'):
                self.snn.load_state_dict(checkpoint_dict[key])
            else:
