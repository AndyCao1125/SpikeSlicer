...
def main():
    ...
    parser.add_argument('--tracker_name', default='dimp',type=str, help='Name of tracking method.')
    parser.add_argument('--tracker_param', default='prdimp50',type=str, help='Name of parameter file.')
    parser.add_argument('--runid', type=int, default=None, help='The run id.')
    parser.add_argument('--dataset_name', type=str, default='eotb_origin', help='Name of dataset (otb, nfs, uav, tpl, vot, tn, gott, gotv, lasot).')
