...
dataset_dict = dict(
    eotb_origin=DatasetInfo(module=pt % "eotb", class_name="EOTBDataset", kwargs=dict(split='origin', groupnum=1)),  ## FE108 for test
    eotb_val=DatasetInfo(module=pt % "eotb", class_name="EOTBDataset", kwargs=dict(split='val', groupnum=5)),  ## FE108_val for snn training
    eotb_test=DatasetInfo(module=pt % "eotb", class_name="EOTBDataset", kwargs=dict(split='test')),  ## FE108_val for snn training,
