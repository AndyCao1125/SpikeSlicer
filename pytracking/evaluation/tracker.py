...
class Tracker:
    ...
    def _track_sequence(self, tracker, seq, init_info):
        ...
        image = self._read_image_npy(seq.frames[0])  ## read numpy
        ...
        for frame_num, frame_path in enumerate(seq.frames[1:], start=1):
            ...
            image = self._read_image_npy(frame_path) ## read event in numpy format
    ...
    def _read_image_npy(self, image_file: str):
