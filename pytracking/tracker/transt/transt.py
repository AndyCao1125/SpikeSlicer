...
class TransT(SiameseTracker):
    ...
    def track(self, image, info: dict = None) -> dict:
        # print("whether true",np.equal(image, np.load('/home/lsf_node01/dataset/FE108/test/airplane_mul222/event_frame/groupnum_1/1.npy').transpose(1, 2, 0)).all())
